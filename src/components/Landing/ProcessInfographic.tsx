  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-purple-50/60 to-indigo-100/80">
        ...
        <div className="absolute bottom-32 right-20 w-40 h-40 bg-gradient-to-l from-purple-400/10 to-indigo-400/10 rounded-full blur-xl animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={step.id} className="relative">
                ...
                {/* Step Card */}
                <div 
                  className={`relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border-2 transition-all duration-700 transform ${
                    isActive 
                      ? 'scale-105 shadow-2xl border-primary bg-white' 
                      : isPrevious
                ...
                >
                  {/* Step Number */}
                  <div className={`absolute -top-4 -left-4 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold font-fira transition-all duration-500 ${
                    isActive 
                  ...
                  {/* Content */}
                  <div>
                    <h3 className={`text-xl font-bold font-inter mb-3 transition-all duration-500 ${
                      isActive 
                        ? 'text-slate-900' 
                        : isPrevious
                          ? 'text-slate-800'
                  ...
                  {/* Active indicator */}
                  {isActive && (
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-primary/5 to-secondary/5 animate-pulse"></div>
                  )}
                </div>
              </div>
            );
        ...
        <div className="flex flex-col items-center space-y-4">
          <button
            ...
            className="group inline-flex items-center space-x-3 px-12 py-4 bg-gradient-to-r from-primary to-secondary text-white font-semibold font-inter text-lg rounded-xl shadow-xl hover:shadow-2xl transform transition-all duration-300 hover:scale-105 hover:from-blue-600 hover:to-purple-600"
          >
