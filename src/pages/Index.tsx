...
const Index = () => {
  ...
  return <div className="min-h-screen relative overflow-hidden flex flex-col w-full">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-slate-50 via-blue-50/40 to-indigo-50/30">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-secondary/8 rounded-full blur-lg animate-pulse" style={{
        animationDelay: '1s'
      }}></div>
        <div className="absolute bottom-32 left-1/4 w-20 h-20 bg-success/6 rounded-full blur-lg animate-pulse" style={{
        animationDelay: '2s'
      }}></div>
        <div className="absolute bottom-20 right-1/3 w-28 h-28 bg-primary/4 rounded-full blur-xl animate-pulse" style={{
        animationDelay: '0.5s'
      }}></div>
        
        {/* Subtle gradient orbs */}
        <div className="absolute top-1/3 left-1/2 w-96 h-96 bg-gradient-to-r from-primary/3 to-secondary/3 rounded-full blur-3xl animate-pulse opacity-60" style={{
        animationDelay: '1.5s'
      }}></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-l from-secondary/4 to-primary/4 rounded-full blur-3xl animate-pulse opacity-50" style={{
        animationDelay: '3s'
      }}></div>
        ...
        <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-primary/20 rounded-full animate-bounce" style={{
        animationDelay: '0s',
        animationDuration: '4s'
      }}></div>
        <div className="absolute top-1/2 right-1/3 w-1 h-1 bg-secondary/25 rounded-full animate-bounce" style={{
        animationDelay: '1s',
        animationDuration: '5s'
      }}></div>
        <div className="absolute bottom-1/3 left-1/3 w-1 h-1 bg-primary/15 rounded-full animate-bounce" style={{
        animationDelay: '2s',
        animationDuration: '6s'
      }}></div>
        <div className="absolute top-2/3 right-1/4 w-1 h-1 bg-secondary/20 rounded-full animate-bounce" style={{
        animationDelay: '3s',
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1">
          {showInput && <>
              ...
              <div className="p-4 px-[22px]">
                <div className="max-w-7xl mx-auto">
                  ...
                  animationDelay: '0.2s'
                }}>Talynx is your AI-powered talent engine — automating resume screening, generating tailored interview questions, and instantly identifying backup team members when it matters most.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6" data-upload-section>
                ...
                animationDelay: '0.4s'
                  ...
                  {/* Action Button */}
                  <div className="flex justify-center py-8 animate-fade-in" style={{
                animationDelay: '0.6s'
              }}>
                    <ProcessingButton />
                  </div>
          ...
          {showResults && <div className="flex justify-center py-6 animate-fade-in">
              <button onClick={() => {
            const {
              resetState
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between text-sm text-slate-500 font-ibm space-y-2 md:space-y-0">
              ...
              <div className="flex items-center space-x-6">
                {processing.timings.total > 0 && <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-success rounded-full animate-pulse"></div>
                    <span>Last processing: {processing.timings.total}s</span>
                  </div>}
                {candidates.length > 0 && <div className="flex items-center space-x-2">
